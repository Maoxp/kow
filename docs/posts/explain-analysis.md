...
<img src="./assets/640.png" alt="图片" style="zoom:50%; float:left" />
...
<img src="./assets/640.jpeg" alt="图片" style="zoom:50%; float:left" />
...
<img src="./assets/640-20240604095851318.png" alt="图片" style="zoom:67%; float:left" />
...
<img src="./assets/640-20240604095954156.jpeg" alt="图片" style="zoom:67%; float:left" />
...
<img src="./assets/640-20240604100029531.png" alt="图片" style="zoom:67%;float:left" />

如果把上例 eq_ref案例中的主键索引，改为**普通非唯一**(non unique)索引。

就由 eq_ref 降级为了 ref，此时**对于前表的每一行(row)，后表可能有多于一行的数据被扫描**。

<img src="./assets/640-20240604100032749.png" alt="图片" style="zoom:50%;float:left" />
...
<img src="./assets/640-20240604100049226.jpeg" alt="图片" style="zoom:70%;float:left" />
...
<img src="./assets/640-20240604100100705.png" alt="图片" style="zoom:50%;float:left" />
...
<img src="./assets/640-20240604100123337.jpeg" alt="图片" style="zoom:80%;float:left" />
